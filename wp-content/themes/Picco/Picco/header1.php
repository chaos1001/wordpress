...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            Cufon.replace('label',  { fontFamily: 'BellCent Add BT' });   
            Cufon.replace('#slide-description',  { fontFamily: 'BellCent Add BT' });    
            Cufon.replace('#nav a',  { fontFamily: 'BellCent Add BT' });   
            Cufon.replace('h5',  { fontFamily: 'BellCent Add BT' });   
            Cufon.replace('h1', { fontFamily: 'AvantGarde Bk BT' });
            Cufon.replace('h2', { fontFamily: 'Abadi MT Condensed Light' });
            Cufon.replace('#fcontent', { fontFamily: 'AvantGarde Bk BT' });
            Cufon.replace('h4', { fontFamily: 'AvantGarde Bk BT' });
            Cufon.replace('#content .post-details-bold', { fontFamily: 'Abadi MT Condensed Light' });		
         </script>
            ...
            <div id="header" class="grid_12">
                ...
                <ul id="nav">
					...
					<?php
                      ...
                      <li<?php if(!is_home() && in_array(get_option('krones_blog_category'), $catID) ) { echo $classNav; } ?>><a href="<?php echo get_category_link(get_option('krones_blog_category')); ?>"><?php echo get_option('krones_blog_page_title'); ?></a><div class="desc"><?php echo get_option('krones_blog_page_description'); ?></div></li>
